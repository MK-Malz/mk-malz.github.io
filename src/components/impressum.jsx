...
<ul>
    ...
    <li><a href="#haftungsausschluss">Haftungsausschluss</a>
      <ul>
        <li><a href="#1-haftung-für-inhalte">1. Haftung für Inhalte</a></li>
        <li><a href="#2-verweise-auf-andere-webseiten">2. Verweise auf andere Webseiten</a></li>
        <li><a href="#3-urheber--und-kennzeichenrecht">3. Urheber- und Kennzeichenrecht</a></li>
        <li><a href="#4-rechtswirksamkeit-dieses-haftungsausschlusses">4. Rechtswirksamkeit dieses Haftungsausschlusses</a></li>
        <li><a href="#5-datenschutz">5. Datenschutz</a></li>
      </ul>
    </li>
  </ul>
...
<p>Ebenfalls ausgeschlossen sind Haftungsansprüche für jegliche unmittelbaren und mittelbaren Schäden, die durch den Zugriff auf unser Onlineangebot entstehen, z. B. durch die Infizierung mit Computerviren. Alle dargebotenen Inhalte sind freibleibend und unverbindlich.</p>
<p>Wir behalten uns ausdrücklich vor, Teile der Seiten oder das gesamte Angebot ohne gesonderte Ankündigung zu verändern, zu ergänzen, zu löschen oder die Veröffentlichung zeitweise oder endgültig einzustellen.</p>
<h3 id="2-verweise-auf-andere-webseiten">2. Verweise auf andere Webseiten</h3>
<p>Auf unserer Webseite wird auf die Webseiten Dritter verwiesen. Wir übernehmen keine Verantwortung für die Inhalte der verlinkten Seiten. Mit dem Betätigen des Verweises verlassen Sie unser Informationsangebot. Für die Angebote Dritter können daher abweichende Regelungen gelten, insbesondere auch hinsichtlich des Datenschutzes.</p>
<p>Wir erklären hiermit ausdrücklich, dass zum Zeitpunkt der Linksetzung keine illegalen Inhalte auf den Seiten erkennbar waren, auf die direkt verwiesen wurde. Auf die aktuelle und zukünftige Gestaltung, die Inhalte oder die Urheberschaft der gelinkten/verknüpften Informationsseiten haben wir keinerlei Einfluss. Deshalb distanzieren wir uns hiermit ausdrücklich von allen Inhalten aller gelinkten/verknüpften Seiten, die nach der Linksetzung verändert wurden.</p>
<p>Diese Feststellung gilt für alle innerhalb unseres Internetangebotes gesetzten Links und Verweise. Für illegale, fehlerhafte oder unvollständige Inhalte und insbesondere für Schäden, die aus der Nutzung oder Nichtnutzung solcherart dargebotener Informationen entstehen, haftet allein der Verantwortliche der Seite, auf welche verwiesen wurde.</p>
<h3 id="3-urheber--und-kennzeichenrecht">3. Urheber- und Kennzeichenrecht</h3>
<p>Unser Onlineangebot ist urheberrechtlich (copyright) geschützt. Alle Rechte für den Inhalt und die Gestaltung stehen alleine uns zu. Das vollständige oder teilweise Reproduzieren, Verbreiten, Übermitteln (elektronisch oder auf andere Weise), Modifizieren oder Benutzen unserer Webseite für öffentliche oder kommerzielle Zwecke ist ohne die vorherige schriftliche Zustimmung von uns untersagt.</p>
...
<h3 id="4-rechtswirksamkeit-dieses-haftungsausschlusses">4. Rechtswirksamkeit dieses Haftungsausschlusses</h3>
...
<h3 id="5-datenschutz">5. Datenschutz</h3>
<p>Die Nutzung unserer oben angegebenen Kontaktdaten zum Zwecke der gewerblichen Werbung ist ohne schriftliche Zustimmung von uns oder ohne einer bestehenden Geschäftsbeziehung ausdrücklich nicht erwünscht. Wir und alle auf unserer Webseite genannten Personen widersprechen ausdrücklich jeder kommerziellen Verwendung und Weitergabe unserer bzw. ihrer Daten.</p>
<p>Ausführliche Informationen zum Datenschutz sind in der folgenden Datenschutzerklärung zu finden.</p>
    ...
    <div id="introduction" className="text-center">
      <div className="container">
        <div className="col-md-10 col-md-offset-1 section-title">
          ...
          <div>
           <h1 className="adsimple-311886100">Einleitung und Überblick</h1>

<p>
  Wir haben diese Datenschutzerklärung (Fassung 23.11.2021-311886100) verfasst,
  um Ihnen gemäß der Vorgaben der
  <a
    className="adsimple-311886100"
  ...
  <strong className="adsimple-311886100">Kurz gesagt:</strong> Wir informieren Sie
...
<h2 id="anwendungsbereich" className="adsimple-311886100">Anwendungsbereich</h2>
<p>
  ...
  Verarbeitung personenbezogener Daten sorgt dafür, dass wir dich über unsere
  Aktivitäten informieren können, sei es online
  oder offline. Der Anwendungsbereich dieser Datenschutzerklärung umfasst alle Onlineauftritte, die wir betreiben.
</p>
<p>
  <strong className="adsimple-311886100">Kurz gesagt:</strong> Die
  Datenschutzerklärung gilt für alle Bereiche, in denen personenbezogene Daten
  über die genannten Kanäle strukturiert verarbeitet werden.
  Sollten wir außerhalb dieser Kanäle mit Ihnen in Rechtsbeziehungen eintreten,
  werden wir Sie gegebenenfalls gesondert informieren.
</p>
<h2 id="rechtsgrundlagen" className="adsimple-311886100">Rechtsgrundlagen</h2>
<p>
...
<ol>
  <li className="adsimple-311886100">
    <strong className="adsimple-311886100">Einwilligung</strong> (Artikel 6 Absatz 1
  ...
  <li className="adsimple-311886100">
    <strong className="adsimple-311886100">Rechtliche Verpflichtung </strong>
    (Artikel 6 Absatz 1 lit. c DSGVO): Wenn wir einer rechtlichen Verpflichtung
    unterliegen, verarbeiten wir Ihre Daten. 
  </li>
  <li className="adsimple-311886100">
    <strong className="adsimple-311886100">Berechtigte Interessen</strong> (Artikel
    ...
    verarbeiten, um unsere Website sicher und wirtschaftlich effizient betreiben
    zu können. Diese Verarbeitung ist somit ein berechtigtes Interesse.
  </li>
</ol>
<h3 className="adsimple-311886100">
    Warum verarbeiten wir personenbezogene Daten?
</h3>
<p>Die Zwecke der Datenverarbeitung sind:</p>
<ol>
    <li className="adsimple-311886100">
        Kontaktaufnahme zwecks Information über unsere Aktivitäten
    </li>
</ol>
<h3 className="adsimple-311886100">Welche Daten werden verarbeitet?</h3>
<p>
    Wir verarbeiten lediglich im Kontaktformular eingegebene Daten (Name und Email).
</p>
<h3 className="adsimple-311886100">Wie lange werden Daten gespeichert?</h3>
<p>
    Die Daten werden so lange gespeichert wie sie zwecks Kommunikation gebraucht werden. Wir geben diese Daten nicht
...
<ul className="adsimple-311886100">
  <li className="adsimple-311886100">
    In <strong className="adsimple-311886100">Deutschland</strong> gilt das
    <strong className="adsimple-311886100"> Bundesdatenschutzgesetz</strong>,
    kurz<strong className="adsimple-311886100"> BDSG</strong>.
  </li>
</ul>
<p>
...
<h2 id="kontaktdaten-verantwortliche" className="adsimple-311886100">
...
<h2 id="speicherdauer" className="adsimple-311886100">Speicherdauer</h2>
<p>
  Dass wir personenbezogene Daten nur so lange speichern, wie es für die
  Information über unsere Aktivitäten notwendig ist,
...
<h2 id="rechte-dsgvo" className="adsimple-311886100">
...
<p>
  <strong className="adsimple-311886100">Kurz gesagt:</strong> Sie haben Rechte
...
<p>
  ...
  In Deutschland gibt es für jedes Bundesland einen
...
<h2 id="nordrhein-westfalen-datenschutzbehoerde" className="adsimple-311886100">
  Nordrhein-Westfalen Datenschutzbehörde
</h2>
<p>
  <strong className="adsimple-311886100">Landesbeauftragte für Datenschutz: </strong>
  Bettina Gayk<br />
  <strong className="adsimple-311886100">Adresse: </strong>Kavalleriestraße 2-4,
  40213 Düsseldorf<br />
  <strong className="adsimple-311886100">Telefonnr.:</strong> 02 11/384 24-0<br />
  <strong className="adsimple-311886100">E-Mail-Adresse: </strong>
  poststelle@ldi.nrw.de<br />
  <strong className="adsimple-311886100">Website: </strong>
  <a
    className="adsimple-311886100"
    href="https://www.ldi.nrw.de/?tid=311886100"
    target="_blank"
    rel="noopener noreferrer"
    > https://www.ldi.nrw.de/</a
  >
</p>
<h2 id="webhosting" className="adsimple-311886100">Webhosting durch GitHub Pages</h2>
<table border="1" cellpadding="15">
  <tbody>
    <tr>
      <td>
        <strong className="adsimple-311886100">Webhosting Zusammenfassung</strong>
        <br />
        ...
        verwendeter Browser und weitere Daten. Die Website wird auf GitHub Pages gehostet. Die Datenschutzbestimmungen finden Sie unter
        <a href="https://help.github.com/articles/github-privacy-statement"> https://help.github.com/articles/github-privacy-statement</a>
        <br />
...
<h3 className="adsimple-311886100">Rechtsgrundlage</h3>
<p>
...
<h2 id="font-awesome-datenschutzerklaerung" className="adsimple-311886100">
...
<table border="1" cellpadding="15">
  <tbody>
    <tr>
      <td>
        <strong className="adsimple-311886100"
          >Font Awesome Datenschutzerklärung Zusammenfassung</strong
        >
        <br />
        &#x1f465; Betroffene: Besucher der Website<br />
        &#x1f91d; Zweck: Optimierung unserer Serviceleistung<br />
        &#x1f4d3; Verarbeitete Daten: etwa IP-Adresse und und welche
        Icon-Dateien geladen werden<br />
        Mehr Details dazu finden Sie weiter unten in dieser
        Datenschutzerklärung.<br />
        &#x1f4c5; Speicherdauer: Dateien in identifizierbarer Form werden wenige
        Wochen gespeichert<br />
...
<h3 className="adsimple-311886100">Was ist Font Awesome?</h3>
<p>
  Wir verwenden auf unserer Website Font Awesome des amerikanischen Unternehmens
  Fonticons (307 S. Main St., Suite 202, Bentonville, AR 72712, USA). Wenn Sie
  eine unserer Webseite aufrufen, wird die Web-Schriftart Font Awesome (im
  Speziellen Icons) über das Font Awesome Content Delivery Netzwerk (CDN)
  geladen. So werden die Texte bzw. Schriften und Icons auf jedem Endgerät
  passend angezeigt. In dieser Datenschutzerklärung gehen wir näher auf die
  Datenspeicherung und Datenverarbeitung durch diesen Service ein.
</p>
<p>
  Icons spielen für Websites eine immer wichtigere Rolle. Font Awesome ist eine
  Web-Schriftart, die speziell für Webdesigner und Webentwickler entwickelt
  wurde. Mit Font Awesome können etwa Icons mit Hilfe der Stylesheet-Sprache CSS
  nach Belieben skaliert und gefärbt werden. Sie ersetzen so alte Bild-Icons.
  Font Awesome CDN ist der einfachste Weg die Icons oder Schriftarten auf Ihre
  Website zu laden. Dafür mussten wir nur eine kleine Code-Zeile in unsere
  Website einbinden.
</p>
<h3 className="adsimple-311886100">
...
<p>
  ...
  werden. So können Sie sich auf unserer Website besser orientieren und die
  Inhalte leichter erfassen. Mit den Icons kann man sogar manchmal ganze Wörter
  ersetzen und Platz sparen. Da ist besonders praktisch, wenn wir Inhalte
  speziell für Smartphones optimieren.  Diese Icons werden statt als Bild als
  HMTL-Code eingefügt. Dadurch können wir die Icons mit CSS genauso bearbeiten,
  wie wir wollen. Gleichzeitig verbessern wir mit Font Awesome auch unsere
  Ladegeschwindigkeit, weil es sich nur um HTML-Elemente handelt und nicht um
  Icon-Bilder. All diese Vorteile helfen uns, die Website für Sie noch
  übersichtlicher, frischer und schneller zu machen.
</p>
<h3 className="adsimple-311886100">
...
<p>
  ...
  verteilt sind und es möglich machen, schnell Dateien aus der Nähe zu laden. So
  werden auch, sobald Sie eine unserer Seiten aufrufen, die entsprechenden Icons
  von Font Awesome bereitgestellt.
</p>
<p>
  Damit die Web-Schriftarten geladen werden können, muss Ihr Browser eine
  Verbindung zu den Servern des Unternehmens Fonticons, Inc. herstellen. Dabei
  wird Ihre IP-Adresse erkannt. Font Awesome sammelt auch Daten darüber, welche
  Icon-Dateien wann heruntergeladen werden. Weiters werden auch technische Daten
  wie etwa Ihre Browser-Version, Bildschirmauflösung oder der Zeitpunkt der
  ausgerufenen Seite übertragen.
</p>
...
<ul className="adsimple-311886100">
  ...
  <li className="adsimple-311886100">um die Beliebtheit von Icons zu erfahren</li>
  <li className="adsimple-311886100">
...
<p>
  ...
  Standardschrift Ihres PCs verwendet. Nach derzeitigem Stand unserer Erkenntnis
  werden keine Cookies gesetzt. Wir sind mit der Datenschutzabteilung von Font
  Awesome in Kontakt und geben Ihnen Bescheid, sobald wir näheres in Erfahrung
  bringen.
</p>
<h3 className="adsimple-311886100">
...
<p>
  Font Awesome speichert Daten über die Nutzung des Content Delivery Network auf
  Servern auch in den Vereinigten Staaten von Amerika. Die CDN-Server befinden
  sich allerdings weltweit und speichern Userdaten, wo Sie sich befinden. In
  identifizierbarer Form werden die Daten in der Regel nur wenige Wochen
  gespeichert. Aggregierte Statistiken über die Nutzung von den CDNs können auch
  länger gespeichert werden. Personenbezogene Daten sind hier nicht enthalten.
</p>
<h3 className="adsimple-311886100">
...
<p>
  ...
  personenbezogenen Daten über die Content Delivery Netzwerke. Wenn Sie nicht
  wollen, dass Daten über die verwendeten Icons gespeichert werden, können Sie
  leider unsere Website nicht besuchen. Wenn Ihr Browser keine Web-Schriftarten
  erlaubt, werden auch keine Daten übertragen oder gespeichert. In diesem Fall
  wird einfach die Standard-Schrift Ihres Computers verwendet.
</p>
<h3 className="adsimple-311886100">Rechtsgrundlage</h3>
<p>
  ...
  Einwilligung stellt laut<strong className="adsimple-311886100">
    Art. 6 Abs. 1 lit. a DSGVO (Einwilligung)</strong
  >
  die Rechtsgrundlage für die Verarbeitung personenbezogener Daten, wie sie bei
  der Erfassung durch Font Awesome vorkommen kann, dar.
</p>
<p>
  Von unserer Seite besteht zudem ein berechtigtes Interesse, Font Awesome zu
...
<p>
  Wir weisen darauf hin, dass nach Meinung des Europäischen Gerichtshofs derzeit
  kein angemessenes Schutzniveau für den Datentransfer in die USA besteht. Die
  Datenverarbeitung geschieht im Wesentlichen durch Font Awesome. Dies kann dazu
  führen, dass gegebenenfalls Daten nicht anonymisiert verarbeitet und
  gespeichert werden. Ferner können gegebenenfalls US-amerikanische staatliche
  Behörden Zugriff auf einzelne Daten nehmen. Es kann ferner vorkommen, dass
  diese Daten mit Daten aus möglichen anderen Diensten von Font Awesome, bei
  denen Sie ein Nutzerkonto haben, verknüpft werden.
</p>
<p>
  ...
  <a
    className="adsimple-311886100"
    href="https://fontawesome.com/help?tid=311886100"
    > https://fontawesome.com/help</a
  >.
</p>
<h2 id="google-fonts-datenschutzerklaerung" className="adsimple-311886100">
...
<table border="1" cellpadding="15">
  <tbody>
    <tr>
      <td>
        <strong className="adsimple-311886100"
          >Google Fonts Datenschutzerklärung Zusammenfassung</strong
        >
        <br />
        &#x1f465; Betroffene: Besucher der Website<br />
        &#x1f91d; Zweck: Optimierung unserer Serviceleistung<br />
...
<h3 className="adsimple-311886100">Was sind Google Fonts?</h3>
<p>
...
<p>
  ...
  <a
    className="adsimple-311886100"
    href="https://de.wikipedia.org/wiki/Google_LLC?tid=311886100"
    > Google</a
...
<p>
  ...
  während andere unter der Apache-Lizenz veröffentlicht wurden. Beides
...
<p>
  ...
  Fehler können teilweise Texte bzw. ganze Webseiten optisch verzerren. Dank des
  ...
  Browser (Google Chrome, Mozilla Firefox, Apple Safari, Opera) und funktioniert
  zuverlässig auf den meisten modernen mobilen Betriebssystemen, einschließlich
  Android 2.2+ und iOS 4.2+ (iPhone, iPad, iPod). Wir verwenden die Google Fonts
  also, damit wir unser gesamtes Online-Service so schön und einheitlich wie
  möglich darstellen können.
</p>
<h3 className="adsimple-311886100">Welche Daten werden von Google gespeichert?</h3>
<p>
  ...
  Verwendung, Speicherung und Erfassung von Endnutzerdaten auf das zu
...
<p>
  ...
  somit geschützt. Durch die gesammelten Nutzungszahlen kann Google feststellen,
  wie gut die einzelnen Schriften ankommen. Die Ergebnisse veröffentlicht Google
  auf internen Analyseseiten, wie beispielsweise Google Analytics. Zudem
  verwendet Google auch Daten des eigenen Web-Crawlers, um festzustellen, welche
  Webseiten Google-Schriften verwenden. Diese Daten werden in der
  BigQuery-Datenbank von Google Fonts veröffentlicht. Unternehmer und Entwickler
  nützen das Google-Webservice BigQuery, um große Datenmengen untersuchen und
  bewegen zu können.
</p>
<p>
...
<p>
  ...
  das Ziel, die Ladezeit von Webseiten grundsätzlich zu verbessern. Wenn
  ...
  später besuchten Webseiten wieder. Manchmal aktualisiert Google
  Schriftdateien, um die Dateigröße zu reduzieren, die Abdeckung von Sprache zu
...
<p>
  ...
  Google übermittelt. Um diese Daten vorzeitig löschen zu können, müssen Sie den
  Google-Support auf
  <a
    className="adsimple-311886100"
    href="https://support.google.com/?hl=de&amp;tid=311886100"
    > https://support.google.com/?hl=de&amp;tid=311886100</a
  >
...
<p>
  ...
  Schriftarten zugreifen und so das Optimum für unsere Webseite rausholen. Mehr
  zu Google Fonts und weiteren Fragen finden Sie auf
  <a
    className="adsimple-311886100"
    href="https://developers.google.com/fonts/faq?tid=311886100"
    > https://developers.google.com/fonts/faq?tid=311886100</a
  ...
  enthalten. Es ist relativ schwierig, von Google wirklich präzise Informationen
...
<p>
  ...
  >
  die Rechtsgrundlage für die Verarbeitung personenbezogener Daten, wie sie bei
  der Erfassung durch Google Fonts vorkommen kann, dar.
</p>
<p>
  Von unserer Seite besteht zudem ein berechtigtes Interesse, Google Font zu
  verwenden, um unser Online-Service zu optimieren. Die dafür entsprechende
  Rechtsgrundlage ist
  <strong className="adsimple-311886100"
    > Art. 6 Abs. 1 lit. f DSGVO (Berechtigte Interessen)</strong
...
<p>
  Google verarbeitet Daten von Ihnen u.a. auch in den USA. Wir weisen darauf
  hin, dass nach Meinung des Europäischen Gerichtshofs derzeit kein angemessenes
...
<p>
  ...
  Terms), welche auch den Standardvertragsklauseln für Google Fonts entsprechen,
  finden Sie unter
  <a
    className="adsimple-311886100"
...
<p>
  ...
  <a
    className="adsimple-311886100"
    href="https://policies.google.com/privacy?hl=de&amp;tid=311886100"
    > https://www.google.com/intl/de/policies/privacy/</a
  >
  nachlesen.
</p>
<h3 className="adsimple-311886100">Was ist emailjs?</h3>
<p>
    Über die Schnittstelle emailjs werden Kontaktanfragen übermittelt, wobei die Kontaktdaten auf keinem Server gespeichert,
    sondern sofort weitergeleitet werden
</p>
